...
export const PresentationNavigatorModal: React.FC<QuickJumpModalProps> = ({
  ...
  const screens: ScreenItem[] = [
    ...
    { id: 'registro_ponto', number: 8, name: 'Tela 09 • Registro de Ponto Eletrônico', category: 'Pessoas', description: 'Registro biométrico simulado com detecção facial na câmera e geolocalização', icon: Clock },
    { id: 'espelho_ponto', number: 9, name: 'Tela 10 • Espelho de Ponto Individual', category: 'Pessoas', description: 'Tabela consolidada de jornadas, saldo de horas e status mensal', icon: FileSpreadsheet },
    { id: 'gestao_ponto', number: 10, name: 'Tela 11 • Gestão de Ponto Corporativa', category: 'Pessoas', description: 'Painel da gerência com status em tempo real de toda a equipe e aprovações', icon: Users },
    { id: 'ai_hub', number: 11, name: 'Tela 12 • AI HUB & Assistente de Gestão', category: 'Inteligência', description: 'Resumos automáticos diários/semanais, insights preditivos e automações', icon: Sparkles },
    { id: 'relatorios', number: 12, name: 'Tela 13 • Relatórios Executivos com IA', category: 'Governança', description: 'Indicadores de produtividade de setores, SLAs e análise automatizada', icon: BarChart3 },
    { id: 'marketing_hub', number: 13, name: 'Tela 14 • Marketing & Vídeos por IA', category: 'Marketing', description: 'Pipeline conceitual de geração de scripts, vídeos e conexões sociais', icon: Video },
    { id: 'whatsapp', number: 14, name: 'Tela 15 • WhatsApp Business Central', category: 'Comunicação', description: 'Central de atendimento multicanal integrada ao CRM e criação de chamados', icon: MessageSquare },
    { id: 'clientes', number: 15, name: 'Tela 16 • Gestão de Clientes & Contratos', category: 'Comercial', description: 'Carteira de clientes atendidos, planos contratados, SLAs e faturamento', icon: Building2 },
    { id: 'chamados', number: 16, name: 'Tela 17 • Help Desk & Chamados', category: 'Operação', description: 'Fila técnica de incidentes N1/N2/N3, priorização e controle de SLA', icon: LifeBuoy },
    { id: 'equipamentos', number: 17, name: 'Tela 18 • Inventário de Equipamentos', category: 'Infraestrutura', description: 'Gestão patrimonial de notebooks, servidores e termos de cautela', icon: HardDrive },
    { id: 'colaboradores', number: 18, name: 'Fase 4 • Colaboradores (Área Privada: Gestão, Adm & RH)', category: 'Gestão & RH', description: 'Ambiente confidencial privado para Gestão, Administração e RH. Quadro funcional, dossiê contratual, salários e governança de acessos', icon: Shield },
    { id: 'auditoria', number: 19, name: 'Tela 19 • Trilha de Auditoria & Segurança', category: 'Governança', description: 'Syslog corporativo imutável para compliance, acessos e LGPD', icon: ShieldCheck },
    { id: 'visao_geral', number: 20, name: 'Tela 20 • Visão Geral da Plataforma', category: 'Executivo', description: 'Diagrama visual do ecossistema integrado: tudo conectado em uma única plataforma', icon: Compass },
    { id: 'design_system', number: 21, name: 'Fase 2 • UX/UI Design System (Área Privada: Gestão, Adm & RH)', category: 'Design UX/UI • Privada', description: 'Ambiente confidencial privado para Gestão, Administração e RH. Mapa de navegação interativo das telas, wireframes responsivos e especificações de produto', icon: Sparkles },
    { id: 'organograma', number: 22, name: 'Fase 3 • Organograma Institucional (Área Privada: Gestão, Adm & RH)', category: 'Estrutura • Privada', description: 'Ambiente confidencial privado para Gestão, Administração e RH. Árvore hierárquica interativa, linhas de comando e simulação de cargos', icon: Network }
  ];
