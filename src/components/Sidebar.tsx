...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const handleOpenNav = onOpenQuickJump || onOpenNavModal;
  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'equipamentos', label: 'Equipamentos TI', icon: HardDrive },
  ...
  return (
    <aside className="w-68 bg-slate-900/95 border-r border-slate-800/80 flex flex-col h-screen shrink-0 backdrop-blur-md select-none">
      {/* Brand Header */}
      ...
      <div className="px-3 pt-3">
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-gradient-to-r from-cyan-950/70 to-slate-800/70 border border-cyan-800/50 hover:border-cyan-500/50 text-cyan-300 hover:text-white text-xs font-semibold shadow-inner group transition-all"
        >
