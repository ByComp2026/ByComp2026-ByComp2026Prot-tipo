...
export const MOCK_COLLABORATORS: Collaborator[] = [
  CURRENT_USER,
  {
    ...
    area: 'SUPORTE',
    sector: 'N1',
    email: 'mariana.castro@bycomp.com.br',
    avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&auto=format&fit=crop&q=80',
    status: 'Em atividade',
    currentTask: 'Triagem de 14 chamados críticos do plantão',
    phone: '(11) 98111-2233',
  ...
  },
  {
    ...
    status: 'Em atividade',
    currentTask: 'Refatoração da arquitetura de micro-frontends',
    phone: '(11) 98333-4455',
  ...
  },
  {
    ...
    area: 'DESENVOLVIMENTO',
    sector: 'Back-End',
    email: 'rodrigo.fontes@bycomp.com.br',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    status: 'Em atividade',
    currentTask: 'Implementação de mensageria com Apache Kafka',
    phone: '(11) 98444-5566',
  ...
  },
  {
    id: 'colab-6',
    name: 'Camila Rocha',
    role: 'DBA Lead & Data Architect',
    userRole: 'GESTOR',
    area: 'DADOS',
    sector: 'DBA',
    email: 'camila.rocha@bycomp.com.br',
  ...
  },
  {
    id: 'colab-7',
    name: 'Lucas Martins',
    role: 'SecOps & Penetration Tester',
    userRole: 'GESTOR',
    area: 'SEGURANÇA',
    ...
    status: 'Em atividade',
    currentTask: 'Auditoria de vulnerabilidades em containers Kubernetes',
    phone: '(11) 98666-7788',
